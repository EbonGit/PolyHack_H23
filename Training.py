...
class Ui_MainWindow(object):
    ...
    def __init__(self):
        ...
        self.image_top_index = None
        self.image_bottom_index = None
        self.image_shoes_index = None
    ...
    def setupUi(self, MainWindow):
        ...
        self.image_top_index = 0
        self.image_bottom_index = 0
        self.image_shoes_index = 0
        self.loadImages("tshirt.jpg", "short.jpg", "shoes.jpg")
    ...
    def loadImages(self, top, bottom, shoes):
        self.pixmap1 = QtGui.QPixmap(top)
        self.pixmap2 = QtGui.QPixmap(bottom)
        self.pixmap3 = QtGui.QPixmap(shoes)
